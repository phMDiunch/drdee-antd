// src/app/api/v1/labo-items/route.ts
...
/**
 * GET /api/v1/labo-items - List labo items with filters
 * Query params: includeArchived
 * Used by: useLaboItems() hook
...
export async function GET(req: Request) {
  try {
    ...
    const data = await laboItemService.list(user, includeArchived);
...
// POST removed - Use createLaboItemAction() Server Action instead
