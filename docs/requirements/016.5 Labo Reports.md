# 016.5 Labo Reports - Báo Cáo & Phân Tích

## 📋 Tổng Quan

**Feature**: Báo cáo và phân tích dữ liệu Labo - Multi-dimension với drill-down

**Mục đích**:

- Phân tích chi phí labo theo nhiều chiều
- Tracking hiệu suất xưởng
- Đánh giá bác sĩ theo volume
...
### US-1: Xem báo cáo tổng quan

**Là** Admin  
**Tôi muốn** xem báo cáo tổng quan chi phí labo  
**Để** nắm tình hình kinh doanh

**Acceptance Criteria**:

- [x] Month Picker: Chọn tháng cần xem báo cáo (format MM/YYYY)
- [x] Clinic Selector: Admin chọn chi nhánh cụ thể hoặc "Tất cả chi nhánh" (Employee không hiển thị)
- [x] Auto-label: Hiển thị "Tháng này", "Tháng trước", hoặc "Tháng MM/YYYY"
- [x] Hiển thị 3 KPI cards với growth % so với tháng trước
- [x] Hiển thị table với 4 dimension tabs (Theo ngày nhận mẫu, Theo xưởng, Theo bác sĩ, Theo dịch vụ)
- [ ] Export Excel button (Not implemented yet)
- [x] Drill-down detail panel khi click row

### US-2: Phân tích theo xưởng

**Là** Admin  
**Tôi muốn** so sánh chi phí giữa các xưởng  
**Để** đánh giá và tối ưu chi phí

**Acceptance Criteria**:

- [x] Group by xưởng
- [x] Metrics: Số lượng đơn, Tổng chi phí (removed avgCost for performance)
- [x] Sort theo chi phí DESC
- [x] Click row để expand detail panel bên dưới

### US-3: Phân tích theo bác sĩ

**Là** Admin  
**Tôi muốn** xem volume công việc của từng bác sĩ  
**Để** đánh giá hiệu suất

**Acceptance Criteria**:

- [x] Group by bác sĩ
- [x] Metrics: Số đơn, Chi phí phát sinh
- [x] Sort theo volume DESC
- [x] Click row để expand detail panel

### US-4: Phân tích theo dịch vụ

**Là** Admin  
**Tôi muốn** xem dịch vụ nào được sử dụng nhiều nhất  
**Để** planning và marketing

**Acceptance Criteria**:

- [x] Group by LaboService (displays serviceName, supplierName, itemName)
- [x] Metrics: Số lượng, Tổng giá trị
...
**Là** Admin  
**Tôi muốn** export báo cáo ra Excel  
**Để** phân tích thêm hoặc báo cáo cấp trên

**Acceptance Criteria**:

- [ ] Button "Xuất Excel" (Not implemented yet)
- [ ] File gồm: Summary sheet + Detail sheet
- [ ] Format: Ngày VN, số tiền VND
...
```
┌────────────────────────────────────────────────────────────────────────────────────────┐
│ 📊 Báo cáo Labo - Tháng này                          [🗓️ 11/2025] [🏥 Chi nhánh A ▼] │
└────────────────────────────────────────────────────────────────────────────────────────┘
...
│              │  │              │
│ 🟢 ↑ +12.5%  │  │ 🟢 ↑ +15.3%  │
│ vs T.trước   │  │ vs T.trước   │
└──────────────┘  └──────────────┘

**Note**: Removed "Chi phí TB" (Average Cost) card for performance optimization

┌────────────────────────────────────────────────────────────────────────────────────────┐
│ 📊 Tổng hợp                                                                            │
│ ──────────────────────────────────────────────────────────────────────────────────────│
│ [Theo xưởng] [Theo bác sĩ] [Theo dịch vụ] [Theo ngày nhận mẫu]                       │
├────────────────────────────────────────────────────────────────────────────────────────┤
│ Tab: Theo xưởng                                                                        │
│                                                                                        │
│ Ranking │ Xưởng         │ Số đơn │ Tổng chi phí │ % Tổng │
│ ──────────────────────────────────────────────────────────────────────────────────────│
│ 🥇 #1   │ Tung Dentalab │   38   │  41,800,000  │ ████ 43.8% │
│  43.8%  │               │        │              │            │
│ ──────────────────────────────────────────────────────────────────────────────────────│
│ 🥈 #2   │ Anh Nam Labo  │   45   │  35,500,000  │ ████ 37.2% │
│  37.2%  │               │        │              │            │
│ ──────────────────────────────────────────────────────────────────────────────────────│
│ 🥉 #3   │ Giang Lab     │   42   │  18,200,000  │ ██ 19.0%   │
│  19.0%  │               │        │              │            │
│ ──────────────────────────────────────────────────────────────────────────────────────│
│  #4     │ Lab Việt      │   15   │   8,500,000  │ █ 8.9%     │
│   8.9%  │               │        │              │            │
│ ──────────────────────────────────────────────────────────────────────────────────────│
│ TỔNG    │               │  125   │  95,500,000  │ ████ 100%  │
└────────────────────────────────────────────────────────────────────────────────────────┘

**Note**: Removed "Chi phí TB" (Average Cost) column - not computed for performance
```

### Dimension: Theo Xưởng

| Ranking | Xưởng         | Số đơn | Tổng chi phí | % Tổng |
| ------- | ------------- | ------ | ------------ | ------ |
| 🥇 #1   | Tung Dentalab | 38     | 41.8M ₫      | 43.8%  |
| 🥈 #2   | Anh Nam Labo  | 45     | 35.5M ₫      | 37.2%  |
| 🥉 #3   | Giang Lab     | 42     | 18.2M ₫      | 19.0%  |

**Note**: Removed "Chi phí TB" (Average Cost) column

### Dimension: Theo Bác sĩ

| Ranking | Bác sĩ         | Số đơn | Tổng chi phí | % Tổng |
| ------- | -------------- | ------ | ------------ | ------ |
| 🥇 #1   | Dr. Nguyễn Văn | 52     | 42.3M ₫      | 44.3%  |
| 🥈 #2   | Dr. Trần Thị   | 38     | 28.7M ₫      | 30.0%  |
| 🥉 #3   | Dr. Lê Minh    | 35     | 24.5M ₫      | 25.7%  |

### Dimension: Theo Nhóm Dịch Vụ

| Ranking | Nhóm dịch vụ (Service/Supplier/Item)  | Số đơn | Tổng chi phí | % Tổng |
| ------- | ------------------------------------- | ------ | ------------ | ------ |
| 🥇 #1   | Răng sứ Katana / Anh Nam / Răng toàn  | 68     | 58.2M ₫      | 60.9%  |
| 🥈 #2   | Răng sứ Zr / Tung Lab / Răng kim loại | 42     | 26.8M ₫      | 28.1%  |
| 🥉 #3   | Invisalign / Giang / Chỉnh nha        | 10     | 7.2M ₫       | 7.5%   |

**Note**: Groups by LaboService (service name, supplier short name, item name)

### Drill-down Detail Panel

Khi click vào row, hiển thị detail panel bên dưới (expand/collapse):

```
┌────────────────────────────────────────────────────────────┐
│ Chi Tiết: Anh Nam Labo (45 đơn)                           │
├────────────────────────────────────────────────────────────┤
│ Ngày gửi │ Khách hàng │ Bác sĩ │ Dịch vụ │ Loại ĐH │ SL │ Giá │
├────────────────────────────────────────────────────────────┤
│ 15/11    │ A (KH001)  │ Dr. N  │ Katana  │ Làm mới │ 2  │ 1.4M│
│ 18/11    │ B (KH002)  │ Dr. T  │ Zr Full │ Bảo hành│ 4  │ 2.8M│
│ ...      │            │        │         │         │    │     │
└────────────────────────────────────────────────────────────┘
```
...
- Empty state when no row selected: "Vui lòng chọn một dòng để xem chi tiết"
...
LaboReportQuery {
  ...
  clinicId?: string          // Optional: Admin có thể chọn clinic hoặc "all"
...
**Implementation**: Backend aggregate với optimized pattern
...
**Implementation**: Backend filter từ base query
...
- **Bảng**: `LaboOrder`
- **Filter field**: `returnDate` (ngày nhận mẫu về từ xưởng) - **CRITICAL**: Dùng `returnDate` chứ KHÔNG phải `sendDate`
...
1. **Base Query (Single DB call):**
   ...
   - Filter: `returnDate` trong tháng (YYYY-MM-01 00:00 → YYYY-MM-31 23:59)
...
- **Percentage**: (Dimension total / Grand total) × 100%
...
- **1 Query Method** (public):
  - `queryAllOrders(month, clinicId?)` - Single DB query với đầy đủ relations
...
**Key Innovation**: Query once, compute many times → 66% fewer DB queries
...
├── components/
│   ├── LaboReportStats.tsx           # 2 KPI cards (removed avgCost)
│   ├── SummaryTabs.tsx               # 4 tabs wrapper
│   ├── SummaryTable.tsx              # Reusable table (4 configs)
│   └── DetailPanel.tsx               # Always visible, lazy load
├── hooks/
│   ├── useLaboReportSummary.ts       # Query summary data
│   └── useLaboReportDetail.ts        # Query detail data (lazy)
├── utils/
│   └── caching.ts                    # Dynamic stale time
...
- `LaboReportStats`: 2 KPI cards (Tổng đơn, Tổng chi phí) với growth indicators
- `SummaryTabs`: 4 tabs (Daily, Supplier, Doctor, Service) - tab change clears selection
- `SummaryTable`: Reusable with 4 dimension configs, click row → update selectedRow
...
```
Given: Có 3 xưởng với orders trong tháng 11:
  - Anh Nam Labo: 45 đơn, 120M
  - Xưởng Việt: 30 đơn, 80M
  - Labo 24h: 15 đơn, 50M
When: Chọn tab "Theo Xưởng", tháng 11/2025
Then:
  - Row 1: 🥇 Anh Nam Labo: 45 đơn, 120M, 48.0%
  - Row 2: 🥈 Xưởng Việt: 30 đơn, 80M, 32.0%
  - Row 3: 🥉 Labo 24h: 15 đơn, 50M, 20.0%
...
```
Given: Report tab "Theo Xưởng"
When: Click vào row "Anh Nam Labo"
Then:
  - DetailPanel hiển thị: "Chi tiết: Anh Nam Labo"
  - Load danh sách 45 orders của xưởng đó
  - Columns: Ngày gửi, Khách hàng (Mã), Bác sĩ, Dịch vụ, Loại ĐH, SL, Giá
  - Pagination: 20 rows/page (frontend)
  - Click row khác → Update detail với xưởng mới
  - Đổi tab → Clear selection, empty state
```

**Actual Implementation**: DetailPanel always visible, empty state shows "Vui lòng chọn một dòng"

### TC-3: MoM Growth Indicator

```
Given:
  - Tháng 10/2025: 100 đơn, 200M
  - Tháng 11/2025: 115 đơn, 250M
When: Chọn tháng 11/2025
Then:
  - Card "Tổng đơn": 115 | 🟢 ↑ +15.0%
  - Card "Tổng chi phí": 250M | 🟢 ↑ +25.0%
```

**Note**: Removed "Chi phí TB" card (avgCost not computed)

### TC-4: Admin-Only Access

```
Given: User là Employee
When: Truy cập /reports/labo
Then:
  - Response: 403 Forbidden
  - Message: "Chỉ admin được xem báo cáo labo"
```
...
```
Given: User là Admin, có 3 chi nhánh
When: Chọn "Tất cả chi nhánh", tháng 11/2025
Then:
  - Hiển thị tổng hợp data từ 3 chi nhánh
  - KPI: Tổng đơn, tổng chi phí của all clinics
  - Dimension tables: Aggregate cross-clinic
  - Detail panel: Hiển thị clinicName trong mỗi order
```
...
- [x] **Critical Fix**: Filter by `returnDate` not `sendDate`
...
- [x] Zod validation với `safeParse`
...
- [x] `components/LaboReportStats.tsx` - 2 KPI cards (removed avgCost)
  - [x] Card 1: Tổng đơn với growth
  - [x] Card 2: Tổng chi phí với growth
- [x] `components/SummaryTabs.tsx` - 4 tabs wrapper
  - [x] Tab change → Clear selection
- [x] `components/SummaryTable.tsx` - Reusable table
  - [x] 4 configs: Daily, Supplier, Doctor, Service
  - [x] Ranking column (🥇🥈🥉) for Supplier/Doctor/Service
  - [x] Percentage column with progress bar
  - [x] Summary footer row
  - [x] Click row → Update selectedRow
- [x] `components/DetailPanel.tsx` - Always visible
  - [x] Empty state: "Vui lòng chọn một dòng..."
  - [x] Data state: Table với 7 cột
  - [x] Dynamic title: "Chi tiết: [key]"
...
- Summary endpoint: 6 queries → 2 queries (**66% reduction**)
- Detail endpoint: 2 queries → 1 query (**50% reduction**)
...
- ✅ Pros: Lower DB load, faster response, scalable, easier to maintain
- ⚠️ Cons: Slightly higher memory usage (acceptable for dental clinic scale)

---

**Version**: 2.0  
**Last Updated**: 2025-12-08  
**Status**: ✅ Production - Live with Optimized Pattern
